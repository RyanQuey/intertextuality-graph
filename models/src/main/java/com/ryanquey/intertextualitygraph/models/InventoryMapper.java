...
import com.ryanquey.intertextualitygraph.models.chapters.ChapterDao;
import com.ryanquey.intertextualitygraph.models.verses.VerseDao;
import com.ryanquey.intertextualitygraph.models.texts.TextDao;
/*
 *
...
public interface InventoryMapper {
  ...
  @DaoFactory 
  ChapterDao chapterDao (@DaoTable String table);

  @DaoFactory 
  VerseDao verseDao (@DaoTable String table);

  @DaoFactory 
  TextDao textDao (@DaoTable String table);
