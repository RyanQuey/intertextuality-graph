...
java -cp $INTERTEXTUALITY_GRAPH_PLAY_API_DIR/lib/data-utils-$DATA_UTILS_VERSION.jar com.ryanquey.datautils.cassandraHelpers.MigrationRunner $INTERTEXTUALITY_GRAPH_KEYSPACE $INTERTEXTUALITY_GRAPH_MIGRATIONS_DIR
