...
// this is if edges and nodes data is passed into the React Vega component directly, not here. Means
// that the spec never has to change
// TODO Test performance against data-supplied spec eventually
export default (data) => ({
